...
namespace MkDocsDatabaseGenerator.ViewModel
{
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        private const string PlantUmlTheme = "!theme materia-outline";
        ...
        #endregion Property : GenerateDocumentationCommand
        ...
        #endregion Property : MergeGeneratedDocumentationCommand
        ...
        #endregion Property : RegenerateYamlCommand
        ...
        #endregion Property : StartStopServerCommand
        ...
        #endregion Property : FolderPathSearchCommand
        ...
        #endregion Property : PlantUmlPathSearchCommand
        ...
        #endregion Property : GraphvizDotPathSearchCommand
        ...
        #endregion Property : JavaPathSearchCommand
        ...
        #endregion Property : SelectedColor
        ...
        private void FolderPathSearch(object o)
        {
            ...
            if (dialog.ShowDialog() is bool isShowed && isShowed)
            {
                FolderPath = dialog.ResultPath;
            }
        }
        ...
        public async Task RenderDiagram(ICollection<Table> tables, string folderPath, string global, CancellationToken? cancellationToken = null)
        {
            ...
            Task globalTask = Task.Run(async () =>
            {
                ...
                byte[] svgBytes = await globalrenderer.RenderAsync(global, OutputFormat.Svg, globalCancellationToken);
            ...
            foreach (Table table in tables)
            {
                ...
                Task tableTask = Task.Run(async () =>
                {
                    ...
                    builder.AppendLine(PlantUmlTheme);
                    ...
                    tableCancellationToken.ThrowIfCancellationRequested();
                    byte[] svgBytes = await renderer.RenderAsync(builder.ToString(), OutputFormat.Svg, cancellationToken: tableCancellationToken);
                ...
                Task referenceTask = Task.Run(async () =>
                {
                    cancellationToken?.ThrowIfCancellationRequested();
                    ...
                    referenceCancellationToken.ThrowIfCancellationRequested();
                    byte[] svgBytes = await renderer.RenderAsync(builder.ToString(), OutputFormat.Svg, referenceCancellationToken);
                    referenceCancellationToken.ThrowIfCancellationRequested();
                ...
                Task referenceByTask = Task.Run(async () =>
                {
                    cancellationToken?.ThrowIfCancellationRequested();
                    ...
                    byte[] svgBytes = await renderer.RenderAsync(builder.ToString(), OutputFormat.Svg, referenceByCancellationToken);
                    referenceByCancellationToken.ThrowIfCancellationRequested();
        ...
        private string generateTableDiagrams(ICollection<Table> tables, string folderPath)
        {
            ...
            global.AppendLine(PlantUmlTheme);
